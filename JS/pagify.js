var pagify = /** @class */ (function () {
  function pagify(_a) {
    ...
    var _b = _a === void 0 ? {} : _a,
      _c = _b.time,
      time = _c === void 0 ? "0.5s" : _c,
      _d = _b.curve,
      curve = _d === void 0 ? "ease" : _d;
    //?Voila Magic
    this.init = function () {
    ...
    this.display = function (
      ...
      if (displayMessage === 1) {
        if (_this.pages[pageNumber].querySelector(":scope .pagifyMessage")) {
          _this.pages[pageNumber].querySelector(
            ":scope .pagifyMessage"
          ).innerHTML = message;
        }
      }
    ...
    this.inputCheck = function (_a, message) {
      var _b = _a === void 0 ? {} : _a,
        _c = _b.displayAlert,
        displayAlert = _c === void 0 ? 1 : _c,
        _d = _b.displayMessage,
        displayMessage = _d === void 0 ? 0 : _d;
      if (message === void 0) {
